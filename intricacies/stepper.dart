...
final Color _kErrorDark = Colors.red;
Color _kCircleActiveLight = Themes.light.focusColor;
Color _kCircleActiveDark = Themes.dark.focusColor;
Color _kDisabledLight = Themes.light.focusColor.withOpacity(0.6);
Color _kDisabledDark = Themes.dark.focusColor.withOpacity(0.6);
...
class _StepperState extends State<Stepper> with TickerProviderStateMixin {
  ...
  bool _isDark() {
    return Theme.of(context).primaryColor == Themes.dark.primaryColor;
  }
          ...
          children: <Widget>[
            TextButton(
              ...
              style: TextButton.styleFrom(
                primary: Colors.green.withAlpha(35),
              ),
              child: Row(
                children: [
                  Padding(
          ...
          secondChild: Container(
            ...
            child: Column(
              children: <Widget>[
                ...
                _buildVerticalControls(), // DISABLED
              ],
            ),
          ),
          firstCurve: const Interval(0.0, 0.6, curve: Curves.fastOutSlowIn),
